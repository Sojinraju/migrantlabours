<?php /* Smarty version 2.6.26, created on 2023-04-29 13:16:06
         compiled from workerPaymentAnnualAmount.tpl */ ?>
<!-- PAGE-HEADER -->
<div class="page-header">
    <h1 class="page-title">Payment</h1>
    <div>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="workerViewAppliedSchemes.php">Applied Schemes</a></li>
    ...
    <div class="col-xl-2">
        <div class="card cart">
            ...
            <div class="card-body">
                ...
                <span class="h3 fw-bold mb-0 border-0 float-end"><?php echo '₹'.$_GET['schemeAmnt'] ?></span>
            </div>
        </div>
    </div>
    <div class="col-xl-10">
