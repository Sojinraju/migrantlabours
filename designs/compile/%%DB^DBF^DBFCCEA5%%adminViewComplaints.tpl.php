<?php /* Smarty version 2.6.26, created on 2023-05-14 09:45:55
         compiled from adminViewComplaints.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'adminViewComplaints.tpl', 291, false),)), $this); ?>
<?php echo '
...
?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $this->_tpl_vars['d']['content']; ?>
</td>
                                                            <td>
                                                                <?php if ($this->_tpl_vars['d']['adminReply'] == null): ?>
                                                                    <font color=red>No Response Given</font>
                                                                <?php else: ?>
                                                                    <?php echo $this->_tpl_vars['d']['adminReply']; ?>
