<?php /* Smarty version 2.6.26, created on 2023-05-14 09:45:39
         compiled from adminViewAgency.tpl */ ?>
<?php echo '
...
?>
                                                        <tr>
                                                            <td><?php echo $this->_tpl_vars['d']['agencyId']; ?>
</td>
                                                            ...
                                                            <td><?php echo $this->_tpl_vars['d']['propName']; ?>
</td>
                                                            ...
                                                            <td>
                                                                <?php if ($this->_tpl_vars['d']['status'] == '0'): ?>
                                                                    <a href="adminApproveAgency.php?id=<?php echo $this->_tpl_vars['d']['loginId']; ?>
"
                                                                        class=" btn w-lg btn-success me-2">Accept</a>
                                                                    <a href="adminRejectAgency.php?id=<?php echo $this->_tpl_vars['d']['loginId']; ?>
"
                                                                        class="btn w-lg btn-danger">Reject</a>
                                                                <?php elseif ($this->_tpl_vars['d']['status'] == '1'): ?>
                                                                    <button
                                                                        class="btn w-lg btn-outline-success me-2 disabled">Accepted</button>
                                                                    <a href="adminRejectAgency.php?id=<?php echo $this->_tpl_vars['d']['loginId']; ?>
"
                                                                        class="btn w-lg btn-danger me-2">Reject</a>
                                                                <?php else: ?>
                                                                    <a href="adminApproveAgency.php?id=<?php echo $this->_tpl_vars['d']['loginId']; ?>
"
                                                                        class=" btn w-lg btn-success me-2">Accept</a>
                                                                    <button
                                                                        class="btn w-lg btn-outline-danger me-2 disabled">Rejected</button>
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
