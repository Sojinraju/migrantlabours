<?php /* Smarty version 2.6.26, created on 2023-05-11 15:04:26
         compiled from agencyHeader.tpl */ ?>
<?php echo '
    <!doctype html>
    ...
    <head>
        ...
        <!-- TITLE -->
        <title>Migrant Labours - Agency</title>
                    ...
                    <div class="app-sidebar">
                        ...
                        <div class="main-sidemenu">
                            ...
                            <ul class="side-menu">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="agencyHome.php"><i
                                            class="side-menu__icon fe fe-home"></i><span
                                            class="side-menu__label">Home</span></a>
                                </li>
                                <li class="slide">
                                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="agencyEdit.php"><i
                                            class="side-menu__icon fe fe-user"></i><span
                                            class="side-menu__label">Profile</span></a>
                                </li>
                                <li class="slide">
                                    <a class="side-menu__item has-link" data-bs-toggle="slide"
                                        href="agencyViewNotifications.php"><i class="side-menu__icon fe fe-bell"></i><span
                                            class="side-menu__label">Notifications</span></a>
                                </li>
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                            class="side-menu__icon fe fe-grid"></i><span
                                            class="side-menu__label">Workers</span><i class="angle fe fe-chevron-right"></i>
                                    </a>
                                    <ul class="slide-menu">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="side29">
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li><a href="agencyViewWorkers.php"
                                                                    class="slide-item">Details</a></li>
                                                            <li class="sub-slide">
                                                                <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                                                    href="javascript:void(0)"><span
                                                                        class="sub-side-menu__label">Attendance</span><i
                                                                        class="sub-angle fe fe-chevron-right"></i></a>
                                                                <ul class="sub-slide-menu">
                                                                    <li><a href="agencyAttendanceWorkers.php"
                                                                            class="slide-item">Mark Attendance</a></li>
                                                                    <li><a href="agencyDailyAttendanceWorkers.php"
                                                                            class="slide-item">
                                                                            Daily Attendance</a>
                                                                    </li>
                                                                    <li><a href="agencyMonthlyAttendanceWorkers.php"
                                                                            class="slide-item">
                                                            ...
                                                            <li class="sub-slide">
                                                                <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                                                    href="javascript:void(0)"><span
                                                                        class="sub-side-menu__label">Work</span><i
                                                                        class="sub-angle fe fe-chevron-right"></i></a>
                                                                <ul class="sub-slide-menu">
                                                                    <li><a href="agencyAssignWork.php"
                                                                            class="slide-item">Assign Work</a></li>
                                                                    <li><a href="agencyWorkDetails.php" class="slide-item">
                                                                            Work Details</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                            <li class="sub-slide">
                                                                <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                                                    href="javascript:void(0)"><span
                                                                        class="sub-side-menu__label">Insurance</span><i
                                                                        class="sub-angle fe fe-chevron-right"></i></a>
                                                                <ul class="sub-slide-menu">
                                                                    <li><a href="agencyViewIns.php" class="slide-item">Apply
                                                                            Insurance</a></li>
                                                                    <li><a href="agencyViewAppliedSchemes.php"
                                                                            class="slide-item">View Applied Schemes</a></li>
                                                                </ul>
                                                            </li>
                                                            <li><a href="agencyPassWorkerDeath.php" class="slide-item">Death
                                                                    Case Passing</a></li>
                                                            <li><a href="agencyVideoConferenceWorkers.php" class="slide-item">Video Conference</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="agencyAddSalary.php"><i
                                            class="side-menu__icon fe fe-briefcase"></i><span
                                            class="side-menu__label">Salary</span></a>
                                </li>
                                <li class="slide">
