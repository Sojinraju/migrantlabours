<?php /* Smarty version 2.6.26, created on 2023-05-13 17:11:05
         compiled from workerLogin.tpl */ ?>
<?php echo '
    <!DOCTYPE html>
    <html>
                ...
                <div class="login-box">
                    ...
                    <div class="login-box-login">
                        <h1><img src=\'Login/logo.svg\' height="60px"><br>Migrant Labours</h1>
                            <p>
                                Please Login With Login ID for Video Conferencing with Agency
                            </p>
                            <form method="post">
                                <input type="hidden" name="hide" value="h">
                                <div>
                                    <label for="loginID">Login ID</label>
                                    <input type="number" required name="loginId" class="input-email" />
                                </div>
                                <div>
                                    <label for="loginID">Passcode</label>
                                    <input type="password" required name="passcode" class="input-password" />
                                </div>
                                <div>
                                    <input type="submit" value="Login to Video Page" class="btn" />
                                </div>
                            </form>
                        </div>
                    </div>
