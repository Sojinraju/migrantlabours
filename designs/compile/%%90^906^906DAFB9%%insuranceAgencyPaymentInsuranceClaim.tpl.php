<?php /* Smarty version 2.6.26, created on 2023-05-09 05:33:42
         compiled from insuranceAgencyPaymentInsuranceClaim.tpl */ ?>
<!-- PAGE-HEADER -->
<div class="page-header">
    ...
    <div>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="insuranceAgencyViewInsuranceClaim.php">Insurance Claims</a>
            </li>
            <li class="breadcrumb-item active"><a
                    href="insuranceAgencyGrantClaim.php?schemeApplyId=<?php echo $this->_tpl_vars['schemeApplyId']; ?>
">Check Details and Pay</a>
            </li>
...
<div class="row">
    <div class="col-xl-2">
        <div class="card cart">
            ...
            <div class="card-body">
                <span class="h6 fw-bold mb-0 border-0 float-start">Total</span><br><br>
                <span class="h3 fw-bold mb-0 border-0 float-end"><?php echo $this->_tpl_vars['amount']; ?>
</span>
            </div>
        </div>
    </div>
                ...
                <div class="card-pay">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active show" id="tab20">
                            <div class="bg-danger-transparent-2 text-danger br-3 mb-4" role="alert">Please Enter Valid
                                Details
                            </div>
                            <form class="form-horizontal" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" maxlength="16" minlength="16" class="form-control"
                                            oninput="this.value = this.value.replace(/[^0-9]/g, '');"
                                            placeholder="**** **** **** ****" name="cardNo" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" min="1" max="12"
                                                    placeholder="MM" required name="month">
                                                <input type="number" class="form-control" min="23" max="99"
                                                    placeholder="YY" required name="year">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="***" maxlength="3"
                                                minlength="3" name="cvv"
                                                oninput="this.value = this.value.replace(/[^0-9]/g, '');" required>
                                        </div>
                                    </div>
                                </div>
                                <input type="submit" value="Make Payment" class="btn  btn-lg btn-primary">
                            </form>
                        </div>
                        <div class="tab-pane" id="tab21">
                            <p>Paypal is easiest way to pay online</p>
                            <p><a href="javascript:void(0)" class="btn btn-primary"><i class="fa fa-paypal"></i> Log in
                                    my
                                    Paypal</a></p>
