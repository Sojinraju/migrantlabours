<?php /* Smarty version 2.6.26, created on 2023-05-14 09:08:09
         compiled from insuranceAgencyEdit.tpl */ ?>
<!-- PAGE-HEADER -->
...
?>
                <div class=" row mb-4">
                    ...
                    <div class="col-md-9">
                        <input type="number" name="insAgId" class="form-control" value="<?php echo $this->_tpl_vars['e']['insAgId']; ?>
"
                ...
                <div class=" row mb-4">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="insAgName" class="form-control" value="<?php echo $this->_tpl_vars['e']['insAgName']; ?>
"
                ...
                <div class=" row mb-4">
                    ...
                    <div class="col-md-9">
                        <textarea type="text" name="address" class="form-control"
                            placeholder="Address"><?php echo $this->_tpl_vars['e']['address']; ?>
</textarea>
                    </div>
                </div>
                <div class=" row mb-4">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="district" class="form-control" value="<?php echo $this->_tpl_vars['e']['district']; ?>
"
                ...
                <div class=" row mb-4">
                    ...
                    <div class="col-md-9">
                        <input type="number" name="contactNo" class="form-control" value="<?php echo $this->_tpl_vars['e']['contactNo']; ?>
"
                ...
                <div class=" row mb-4">
                    ...
                    <div class="col-md-9">
                        <input type="email" name="email" class="form-control" value="<?php echo $this->_tpl_vars['e']['email']; ?>
" placeholder="Email">
                    </div>
                </div>
