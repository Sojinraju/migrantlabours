<?php /* Smarty version 2.6.26, created on 2023-05-14 09:18:25
         compiled from labourCommissionHeader.tpl */ ?>
<?php echo '
    <!doctype html>
    ...
    <head>
        ...
        <!-- TITLE -->
        <title>Migrant Labours - Labour Commission</title>
                            ...
                            <ul class="side-menu">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item has-link" data-bs-toggle="slide"
                                        href="labourCommissionHome.php"><i class="side-menu__icon fe fe-home"></i><span
                                            class="side-menu__label">Home</span></a>
                                </li>
                                <li class="slide">
                                    <a class="side-menu__item has-link" data-bs-toggle="slide"
                                        href="labourCommissionChangePassword.php"><i class="side-menu__icon fe fe-life-buoy"></i><span
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="side29">
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li><a href="labourCommissionViewWorkers.php"
                                                                    class="slide-item">Details Passing</a></li>
                                                            <li><a href="labourCommissionPassWorkerDeath.php"
                                                                    class="slide-item">Death Case Passing</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
