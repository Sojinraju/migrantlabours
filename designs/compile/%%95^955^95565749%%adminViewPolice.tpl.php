<?php /* Smarty version 2.6.26, created on 2023-05-14 09:45:38
         compiled from adminViewPolice.tpl */ ?>
<?php echo '
                            ...
                            <ul class="side-menu">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                            ...
                                            class="side-menu__label">Pass Notification</span><i
                                                    ...
                                                    <div class="tab-pane active" id="side29">
                                                        <ul class="sidemenu-list">
                                                            <li class="side-menu-label1"><a
                                                                    href="javascript:void(0)">Pass Notification</a></li>
                    ...
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                <h1 class="page-title">Police Stations</h1>
                                <div>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0)">View Details</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Police Stations</li>
                                    </ol>
                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($this->_tpl_vars['d']['status'] == '0'): ?>
                                                                    <a href="adminApprovePolice.php?id=<?php echo $this->_tpl_vars['d']['loginId']; ?>
"
                                                                        class=" btn wg-l btn-success me-2">&nbsp;&nbsp;Accept&nbsp;&nbsp;</a>
                                                                    <a href="adminRejectPolice.php?id=<?php echo $this->_tpl_vars['d']['loginId']; ?>
"
                                                                        class="btn wg-l btn-danger">&nbsp;&nbsp;Reject&nbsp;&nbsp;</a>
                                                                <?php elseif ($this->_tpl_vars['d']['status'] == '1'): ?>
                                                                    <button
                                                                        class="btn wg-l btn-outline-success me-2 disabled">Accepted</button>
                                                                    <a href="adminRejectPolice.php?id=<?php echo $this->_tpl_vars['d']['loginId']; ?>
"
                                                                        class="btn wg-l btn-danger me-2">&nbsp;&nbsp;Reject&nbsp;&nbsp;</a>
                                                                <?php else: ?>
                                                                    <a href="adminApprovePolice.php?id=<?php echo $this->_tpl_vars['d']['loginId']; ?>
"
                                                                        class=" btn wg-l btn-success me-2">&nbsp;&nbsp;Accept&nbsp;&nbsp;</a>
                                                                    <button
                                                                        class="btn wg-l btn-outline-danger me-2 disabled">Rejected</button>
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
