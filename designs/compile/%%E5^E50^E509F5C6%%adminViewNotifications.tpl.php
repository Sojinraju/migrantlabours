<?php /* Smarty version 2.6.26, created on 2023-05-14 10:18:31
         compiled from adminViewNotifications.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'adminViewNotifications.tpl', 289, false),)), $this); ?>
<?php echo '
...
?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="text-wrap"><?php echo $this->_tpl_vars['d']['notification']; ?>
</div>
                                                            </td>
                                                            <td>
                                                                <a href="adminEditNotification.php?id=<?php echo $this->_tpl_vars['d']['notificationId']; ?>
"
                                                                    class=" btn btn-primary me-2">Edit</a>
                                                                <a href="adminDeleteNotification.php?id=<?php echo $this->_tpl_vars['d']['notificationId']; ?>
"
