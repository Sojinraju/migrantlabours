<?php /* Smarty version 2.6.26, created on 2023-05-09 09:41:04
         compiled from insuranceAgencyHeader.tpl */ ?>
<?php echo '
    <!doctype html>
    ...
    <head>
        ...
        <!-- TITLE -->
        <title>Migrant Labours - Insurance Agency</title>
                            ...
                            <ul class="side-menu">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item has-link" data-bs-toggle="slide"
                                        href="insuranceAgencyHome.php"><i class="side-menu__icon fe fe-home"></i><span
                                            class="side-menu__label">Home</span></a>
                                </li>
                                <li class="slide">
                                    <a class="side-menu__item has-link" data-bs-toggle="slide"
                                        href="insuranceAgencyEdit.php"><i class="side-menu__icon fe fe-user"></i><span
                                            class="side-menu__label">Profile</span></a>
                                </li>
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                            class="side-menu__icon fe fe-grid"></i><span
                                            class="side-menu__label">Insurance</span><i
                                                    ...
                                                    <div class="tab-pane active" id="side29">
                                                        <ul class="sidemenu-list">
                                                            <li class="side-menu-label1"><a
                                                                    href="javascript:void(0)">Insurance</a></li>
                                                            <li><a href="insuranceAgencyRegisterScheme.php"
                                                                    class="slide-item">Register
                                                                    New Scheme</a></li>
                                                            <li><a href="insuranceAgencySchemes.php"
                                                                    class="slide-item">Schemes</a>
                                                            </li>
                                                            <li><a href="insuranceAgencyViewAppliedSchemes.php"
                                                                    class="slide-item">View Applied Schemes</a>
                                                            </li>
                                                            <li><a href="insuranceAgencyViewInsuranceClaim.php"
                                                                    class="slide-item">Insurance Claims</a>
                                                            </li>
                                                            <li><a href="insuranceAgencyClaimDetails.php"
                                                                    class="slide-item">Claim Details</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
