<?php /* Smarty version 2.6.26, created on 2023-05-14 09:45:45
         compiled from adminAddNotification.tpl */ ?>
<?php echo '
    <!doctype html>
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Pass Notification to Agency</h4>
                                </div>
                                <div class="card-body">
                                    <form class="form-horizontal" method="post">
                                        ...
                                        <div class="mb-0 mt-4 row justify-content-end">
                                            <div class="col-md-9">
                                                <input type="submit" class="btn btn-primary" value="Add and Pass">
                                            </div>
                                        </div>
                                    </form>
                                </div>
