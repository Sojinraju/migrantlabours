<?php /* Smarty version 2.6.26, created on 2023-04-24 07:38:33
         compiled from agencyAddSalary.tpl */ ?>
<!-- PAGE-HEADER -->
...
?>
                        <tr>
                            <td><?php echo $this->_tpl_vars['d']['work']; ?>
</td>
                            <td><?php echo $this->_tpl_vars['d']['salary']; ?>
</td>
                            <td>
                                <a href="agencyEditSalary.php?id=<?php echo $this->_tpl_vars['d']['salaryId']; ?>
