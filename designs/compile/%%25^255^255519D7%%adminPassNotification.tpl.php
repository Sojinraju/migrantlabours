<?php /* Smarty version 2.6.26, created on 2023-04-16 06:43:46
         compiled from adminPassNotification.tpl */ ?>
<?php echo '
    <!doctype html>
                    ...
                    <div class="app-sidebar">
                        ...
                        <div class="main-sidemenu">
                            ...
                            <ul class="side-menu">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="adminHome.php"><i
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                            ...
                                            class="side-menu__label">Notification</span><i
                                                    ...
                                                    <div class="tab-pane active" id="side29">
                                                        <ul class="sidemenu-list">
                                                            <li class="side-menu-label1"><a
                                                                    href="javascript:void(0)">NOtification</a></li>
                                                            <li><a href="adminViewPolice.php" class="slide-item">Police
                                                                    Stations</a></li>
                                                            <li><a href="adminViewAgency.php"
                                                                    class="slide-item">Agencies</a></li>
                    ...
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                ...
                                <div>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Pass
                                                Notification</a></li>
