<?php /* Smarty version 2.6.26, created on 2023-05-14 09:45:41
         compiled from adminViewInsuranceAgency.tpl */ ?>
<?php echo '
                    ...
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                <h1 class="page-title">Insurance Agencies</h1>
                                <div>
                                    <ol class="breadcrumb">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($this->_tpl_vars['d']['status'] == '0'): ?>
                                                                    <a href="adminApproveInsurance.php?id=<?php echo $this->_tpl_vars['d']['loginId']; ?>
"
                                                                        class=" btn wg-l btn-success me-2">&nbsp;&nbsp;Accept&nbsp;&nbsp;</a>
                                                                    <a href="adminRejectInsurance.php?id=<?php echo $this->_tpl_vars['d']['loginId']; ?>
"
