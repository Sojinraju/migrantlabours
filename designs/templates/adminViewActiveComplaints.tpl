                                ...
                                {foreach from=$data item="d" key="k"}
                                    <div class="card text-white bg-primary ribbone-card">
                                        ...
                                        <div class="card-header">
                                            <h3 class="card-title text-white ms-7">{$d.currentDate|date_format:"%d-%m-%Y"}
                                            </h3>
                                        </div>
                                        <div class="card-body">
                                            <p class="card-text">Worker Name: {$d.workerName}
                                                <br>Aadhaar: {$d.aadhaar}
                                                <br>Email: {$d.email}
                                                <br>Agency: {$d.agencyName}
                                            </p>
                                        ...
                                        <div class="card-footer">
                                            <form action="" method="post">
                                                ...
                                                <input type="hidden" name="complaintId" value="{$d.complaintId}">
                                                <div class=" row mb-4">
