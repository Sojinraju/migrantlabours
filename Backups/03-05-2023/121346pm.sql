...
CREATE TABLE `complaint` (
  `complaintId` int(50) NOT NULL AUTO_INCREMENT,
  `subject` varchar(50) NOT NULL,
  `content` text NOT NULL,
  `worker_loginId` varchar(50) NOT NULL,
  `currentDate` date NOT NULL,
...
CREATE TABLE `payment` (
  ...
  `currentDate` date NOT NULL,
  `schemeApplyId` varchar(50) NOT NULL,
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `scheme` (
  `schemeId` int(30) NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2023-05-03 12:13:48
