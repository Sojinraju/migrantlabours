...
INSERT INTO `bank` VALUES (1,'Federal Bank','Kollam','FBI03456FI','Anjali Singh','84487853212','VISA','8888888888888888','123','2023-04-12','1004222','9999999999'),(2,'State Bank Of India','Kundara','SBIN004587','Admin NIC Kerala','48487853212','RUPAY','1111111111111111','123','2099-04-12','10778','8888888888');
...
INSERT INTO `complaint` VALUES (1,'Related to salary','Salary is low',32,'2023-05-02','Dei dei  pani edukk'),(2,'Related to Work','Work is heavy',32,'2023-05-01','');
...
--
-- Table structure for table `insuranceclaim`
--
...
CREATE TABLE `insuranceclaim` (
  `insClaimId` int(10) NOT NULL AUTO_INCREMENT,
  `schemeApplyId` int(10) NOT NULL,
  `currentDate` date NOT NULL,
  `medicalReport` text NOT NULL,
  PRIMARY KEY (`insClaimId`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `insuranceclaim`
--

LOCK TABLES `insuranceclaim` WRITE;
/*!40000 ALTER TABLE `insuranceclaim` DISABLE KEYS */;
INSERT INTO `insuranceclaim` VALUES (2,9,'2023-05-05','091707am.sql'),(3,5,'2023-05-08','');
/*!40000 ALTER TABLE `insuranceclaim` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `payment` VALUES (1,'Rakesh Sharma','8888888888888888','123','11/23','3000','32','2023-05-01',5),(2,'Rakesh Sharma','8888888888888888','123','11/23','3000','32','2022-05-01',5),(5,'Admin NIC Kerala','1111111111111111','123','01/99','5500','29','2023-05-09',5);
...
INSERT INTO `scheme` VALUES (1,'Life Insurance','Jeevan','3000','2','This is a life insurance scheme','10',29),(2,'Accidental Protection','loocaa','5500','8','free food free wifi','15',29);
...
INSERT INTO `schemeapply` VALUES (5,32,1,'2023-04-10','1','Aadhar.png','1'),(6,33,1,'2023-04-10','1','iddd.png','0'),(9,32,2,'2023-04-10','1','idcard2.png','0'),(10,35,2,'2023-04-10','0','','0'),(11,40,1,'2023-04-11','0','','0'),(12,39,1,'2023-04-11','0','','0'),(13,32,1,'2023-05-09','0','','0');
...
INSERT INTO `video` VALUES (42,'http://localhost/MigrantLabours/agencyVideo.php?worker_loginId=38#20230514213937',24,38,'2023-05-14','21:39:37','2023-05-15','21:39:00');
...
-- Dump completed on 2023-05-15 20:27:29
